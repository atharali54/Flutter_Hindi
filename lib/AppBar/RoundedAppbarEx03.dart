...
class RoundedAppbarEx03 extends StatefulWidget {
  @override
  _TitleCenterEx01State createState() => _TitleCenterEx01State();
}

class _TitleCenterEx01State extends State<RoundedAppbarEx03> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        shape: RoundedRectangleBorder(
          side: BorderSide(color: bordercolor, width: sliwidth, style: style),
        ),
        title: Text(
          'AppBar',
